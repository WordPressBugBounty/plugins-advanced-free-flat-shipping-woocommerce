 ...
 *
 * @wordpress-plugin
 * Plugin Name:       PiWeb Advanced Flat rate / Conditional shipping for WooCommerce
 * Plugin URI:        https://www.piwebsolution.com/advanced-free-flat-shipping-woocommerce
...
add_action('after_plugin_row_advanced-free-flat-shipping-woocommerce-pro/extended-flat-rate-shipping-woocommerce.php', function ($plugin_file, $plugin_data) {
    $url = wp_nonce_url(
        self_admin_url( 'plugins.php?action=deactivate&plugin=advanced-free-flat-shipping-woocommerce/extended-flat-rate-shipping-woocommerce.php' ),
        'deactivate-plugin_advanced-free-flat-shipping-woocommerce/extended-flat-rate-shipping-woocommerce.php'
    );
    ?>
    <tr class="plugin-update-tr">
        <td colspan="13" class="plugin-update" style="background:rgba(255,0,0,0.5);">
            <div style="margin: 10px;">
                <p style="color:#FFF;"><?php echo wp_kses_post( '⚠️ Deactivate the free version of <b>Advanced Free - Flat Shipping WooCommerce</b>, then only the PRO version will work' ); ?>
                    <a href="<?php echo esc_url( $url ); ?>" class="button button-secondary">
                        <?php esc_html_e( 'Deactivate Free Version', 'advanced-free-flat-shipping-woocommerce' ); ?>
                    </a>
                </p>
            </div>
        </td>
 ...
 * Start at version 1.6.6.14 and use SemVer - https://semver.org
 * Rename this for your plugin and update it as you release new versions.
 */
define( 'EXTENDED_FLAT_RATE_SHIPPING_WOOCOMMERCE_VERSION', '1.6.6.14' );
define('PI_EFRS_BUY_URL', 'https://www.piwebsolution.com/cart/?add-to-cart=2804&variation_id=2810&utm_campaign=advance-shipping-free-plugin&utm_source=website&utm_medium=direct-buy');
define('PI_EFRS_PRODUCT_PAGE_URL', 'https://www.piwebsolution.com/product/pro-woocommerce-advanced-free-shipping-advanced-flat-rate-shipping-for-woocommerce/?utm_campaign=advance-shipping-free-plugin&utm_source=website&utm_medium=direct-buy');
define('PI_EFRS_PRICE', '34');
...
function activate_extended_flat_rate_shipping_woocommerce() {
    ...
    pisol_efrs_sample_shipping::default_shipping();
...
add_action('admin_init', function (){
    if (get_option('pi_efrs_do_activation_redirect', false)) {
        ...
        {
            wp_safe_redirect(admin_url("admin.php?page=pisol-efrs-notification"));
            exit;
        }
    }
});
