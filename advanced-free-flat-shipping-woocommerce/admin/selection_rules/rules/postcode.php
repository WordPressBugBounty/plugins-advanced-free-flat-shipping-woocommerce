...
class Pi_efrs_selection_rule_postcode{
    ...
    function savedDropdown($html, $values, $count){
        $html = Pi_efrs_selection_rule_main::createTextField($count, $this->condition,  $values);
    ...
    function conditionCheck($result, $package, $logic, $values){
                    ...
                    $or_result = false;
                    $cart_postcode = PISOL\EFRS\Package::get_postcode($package);
...
new Pi_efrs_selection_rule_postcode(PI_EFRS_SELECTION_RULE_SLUG);