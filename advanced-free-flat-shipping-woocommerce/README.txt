...
With our plugin, you can group products into packages based on category or shipping class or Virtual category. This allows separate shipping methods and costs for each package within the same order.
...
<ul>
	...
	<li><a href="https://woocommerce.com/products/woocommerce-memberships/" target="_blank">WooCommerce Memberships</a> integration: Show a shipping method based on the membership plan of the user</li>
	<li><a href="https://woocommerce.com/products/woocommerce-subscriptions/" target="_blank">WooCommerce Subscriptions</a> integration: Show a shipping method when user is bying a subscription product</li>
	<li><a href="https://woocommerce.com/products/woocommerce-subscriptions/" target="_blank">WooCommerce Subscriptions</a> integration: Show a shipping method when user has an acitive subscription of any product</li>
</ul>
...
Virtual category allows you to create a group of product as per your shipping needs, this virtual category does not affect your site URL structure this Virtual category is only used in our plugin shipping method.

You can create a virtual category that is like a group of multiple categories, and you can use this virtual category inside the Conditions of shipping method. This gives you fine control over the shipping method.
...
== Additional charges in our WooCommerce shipping plugin  ==
...
These are the different conditions available in our WooCommerce shipping plugin:

* [How to set up shipping based on cart quantity?](https://www.youtube.com/watch?v=0CTSrfgaKvc)
* [How to configure shipping based on cart weight?](https://www.youtube.com/watch?v=TriQypJAgYI)
* [Can I apply shipping based on cart subtotal in WooCommerce?](https://www.youtube.com/watch?v=30tS78nMk40)
* [How to create shipping rules based on product quantity?](https://www.youtube.com/watch?v=lD7gm9PHkvE)
* [Is it possible to apply shipping based on category quantity?](https://www.youtube.com/watch?v=6S1eVLuR6b8)
* [How to define shipping using shipping class quantity?](https://www.youtube.com/watch?v=DK04pdaB4u0)
* [Can shipping be calculated based on individual product weight?](https://www.youtube.com/watch?v=aOjKK5LfR04)
* [How to apply shipping using total category weight?](https://www.youtube.com/watch?v=gyhR2OvUDgw)
* [How to set shipping based on shipping class weight?](https://www.youtube.com/watch?v=qIZM7VUUy1c)
* [Is there a way to use shipping based on product subtotal?](https://www.youtube.com/watch?v=sFdiwsoWvBw)
* [How to calculate shipping using category subtotal in WooCommerce?](https://www.youtube.com/watch?v=XPNsq5U6FHA)
* [How can I use shipping based on shipping class subtotal?](https://www.youtube.com/watch?v=GFuvQlEiELE)

== Combine multiple shipping method into single shipping method (PRO) ==
Say your have shipping method A and B on the checkout page each shipping method costing 2 and 3 $ respectively and you want to combine them and show them as single shipping method then you can do that using our plugin so it will show combined shipping method as D whose shipping cost will be 5$ and if you want you can hide the method A and B when this combined method is being shown
...
* offer free shipping based on the price or products’ quantity in the cart,
...
2. Basic configuration of the shipping method
3. Conditions available in the shipping method
4. List of conditions available in the shipping method
5. Table rate shipping method configuration
6. Additional charge configuration in the shipping method
7. Multiple shipping packages configuration in the shipping method

== Frequently Asked Questions ==
= I want to offer shipping for specific county =
Yes you can do that using our country based rule

= I want to offer flat rate shipping for specific country when their subtotal exceeds certain amount =
Yes you can do that by creating a shipping method and adding rule of country and subtotal in it, so when the subtotal will be greater than specified amount and the country selected is as per your rule it will apply this flat rate shipping
...
= I want to charge customer a different shipping rate on Weekend than weekdays =
In the pro version we have a rule that allow you to offer a different shipping method based on the day of the week 

= I want to show a shipping method only on weekends =
...
You have to set a product rule like: a cart contains product equal to Christmas cake, then give a shipping method of cost $20.

= How do I set shipping method based on product category and country? =
You have to select rule for cart contains category's product equal to Halloween toy and select country equal to UK then give shipping method of cost $30.

= What happens when multiple shipping method rules match (PRO) =
Each shipping method gives you option to remove other shipping methods of lower priority the options available are as:
...
Yes, you can create different shipping zones in WooCommerce as per your requirements (based on countries/states/zip-codes), and then you can assign different shipping methods to different zones by using shipping zone condition rule.

= I want to offer a different shipping method based on the Delivery day selected by the customer =
You will need to install our [Order date and time plugin](https://wordpress.org/plugins/pi-woocommerce-order-date-time-and-type/) to take the delivery date from the customer and then based on the day selected by the customer you can show appropriate shipping method
...
= Will it show same day shipping method when all the product in the cart are in Stock =
Yes that can be done we have a rule "Stock status of product in cart" using this rule you can activate the shipping method when all the products in user cart are in stock

= I want to charge shipping as percent of subtotal, but I want the min shipping charge to be 10$ and max shipping charge should not exceed 50$ =
...
= I want to only show one shipping method so customers don't have to choose from multiple shipping methods and I want to show the most expensive of them =
...
= 1.6.6.6 =
* Tested for WP 7.0
* Our shipping method will be available under COD payment method setting
...
= 1.6.4.79 =
* charge shipping based on customer IP address country
...
= 1.6.4.72 =
* Advanced Flat rate shipping plugin Tested for WC 10.0.4
* PRO limited time offer added

= 1.6.4.71 =
* Tested for WC 10.0.2

= 1.6.4.70 =
* make the Advanced Flat rate shipping plugin more user-friendly by simplifying the UI
...
* shortcode support given in the additional charge

= 1.6.4.23 =
* Shipping class cost bug fixed and now supports shortcode [qty] in shipping class cost
